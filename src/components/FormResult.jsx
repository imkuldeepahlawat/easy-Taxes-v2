...
const dispatch = useDispatch();
  ...
  <tr className="flex gap-4 p-3 border bg-slate-500">
    ...
    {dependencies === true ? <th className="w-[20%]">Dependent Name</th> : null}
    <th className="w-[20%]">Marital Status</th>
    {maritalStatus === true ? <th className="w-[20%]">Children</th> : null}
  </tr>
  <tr className="flex gap-4 p-3 border">
    ...
    {dependencies === true ? <td className="w-[20%] uppercase">{nameOfDependent}</td> : null}
    <td className="w-[20%] uppercase">
      {maritalStatus === false ? "Single" : "Married"}
    </td>
    {children === true  && maritalStatus === true ? <td className="w-[20%] uppercase">Yes</td> : null}
  </tr>
</table>
,
      ]}
